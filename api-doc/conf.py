...
sys.path.insert(
    0, os.path.abspath("../api/src/nicomotion/scripts/nicomoveit/moveitwrapper")
)
...
project = u"NICO"
copyright = u"2016-2021, Universität Hamburg"
...
latex_documents = [
    ("index", "NICO.tex", u"NICO Documentation", u"Marcus Soll", "manual"),
]
...
man_pages = [
    ("index", "nico", u"NICO Documentation", [u"Connor Gäde", u"Marcus Soll"], 1)
]
