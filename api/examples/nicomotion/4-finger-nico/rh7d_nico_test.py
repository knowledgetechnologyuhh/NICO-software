...
robot.setAngle("l_wrist_z", -45, 1.)
# robot._robot.l_wrist_z.compliant = False
# robot._robot.l_wrist_z.goal_position = -45
robot.setHandPose("LHand", "thumbsUp")
sleep(4)
robot.setAngle("l_shoulder_z", 0, .05)
robot.setAngle("l_wrist_z", 0, 1.)
# robot._robot.l_wrist_z.goal_position = 0
robot.openHand("LHand")
sleep(1.25)
robot.setAngle("l_shoulder_y", 0, 0.05)
robot.setAngle("l_elbow_y", 80, 0.05)
