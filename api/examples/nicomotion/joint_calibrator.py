...
#     "../../../json/nico_humanoid_legged_with_hands_mod.json", vrep=True)
...
for jNames in (realRobot.getJointNames()):
    ...
    print("Setting real Robot: Joint " +
          str(jNames) + " to position " + str(targetPosition))

    realRobot.setAngle(jNames, targetPosition, 0.05)

print("OK. Time to calibrate the offsets. Make the real robot look like the " +
      "virtual one.")
