...
namespace kinematics
{
  class KinematicsServer
  {
    ...
    {  
      ...
      Eigen::Affine3d translation(Eigen::Translation3d(Eigen::Vector3d(req.pose.position.x,req.pose.position.y,req.pose.position.z)));
      ...
      if (found_ik){
        ...
        const Eigen::Affine3d &reached = kinematic_state->getGlobalLinkTransform(req.tip.data);
    ...
    {          
      ...
      const Eigen::Affine3d &fk_solution = kinematic_state->getGlobalLinkTransform(req.tip.data);
