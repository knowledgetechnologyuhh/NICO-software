...
class Freezer:
    ...
    def torque_joints_from_subset(self, subsetfname=None, stiffness=None, untorque=False):
...
if __name__ == "__main__":
    ...
    subsets_hands = {"l": "../../../../../moves_and_positions/subset_left_hand.csv",
    ...
    parser.add_argument('--json', nargs='?', default='../../../../../json/nico_humanoid_upper.json',
    ...
    while(True):
        ...
        if command[:1] == "f":
            ...
            freezer.freeze_joints(
                subsetfname=subsets[command[1:]], stiffness=0.8, unfreeze=False)
        ...
        if command[:1] == "o":
            ...
            freezer.close_hands(subsets_hands[command[1:]],command[1:], open=True)
