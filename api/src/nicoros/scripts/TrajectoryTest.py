...
The script creates a simple joint trajectory and sends it in form of an action
to the TrajectoryServer.
"""
...
client = actionlib.SimpleActionClient(
    '/nico/trajectory', control_msgs.msg.FollowJointTrajectoryAction)
print 'waiting'
